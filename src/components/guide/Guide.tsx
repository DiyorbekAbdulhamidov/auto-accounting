...
export function GuideFindings() {
  ...
  return (
      ...
      <Card>
        ...
        <p className="mt-2 text-body text-ink-2">
          {t("Ҳақиқий 7 ойлик маълумотда — 1,37 млрд сўм айланма, 152 ўтказма, 159 фактура, 35 контрагент. Тизим буxгалтер ЎТКАЗИБ ЮБОРГАН фарқларни топди:")}
        </p>
...
export function GuideFaq() {
  ...
  return (
      ...
      <Card>
        ...
        <div className="mt-3">
          <Faq q={t("Тизим рақамни ўзи тузатиб қўядими?")}>
            {t("Йўқ. Ҳеч қачон. Тизим фақат файлда нима ёзилганини ўқийди ва фарқни кўрсатади. Тўғрилаш — сизнинг қарорингиз.")}
          </Faq>
          <Faq q={t("Қайси банкларнинг файллари ўқилади?")}>
            {t("Ҳозир танийдиган шакллар: Hamkorbank, Ipoteka / ASBT ва бир нечта умумий кўринишлар. Нотаниш шакл келса, тизим уни ўрганиб олади ва кейинги сафар ўзи танийди.")}
          </Faq>
          <Faq q={t("Файлларим кимга кўринади?")}>
            {t("Фақат сизга. Ҳар бир ҳисоб ўз иш майдонида ишлайди — бошқа фойдаланувчи сизнинг корхоналарингизни ҳам, суммаларингизни ҳам кўрмайди.")}
          </Faq>
          <Faq q={t("Пулими?")}>
            {t("Бепул режада 3 та корхона. Сверканинг ўзи чексиз — қанча хоҳласангиз шунча марта қайта юкласангиз бўлади.")}
          </Faq>
          <Faq q={t("Коммунал ва солиқ тўловлари сверкани чалғитмайдими?")}>
            {t("Улар алоҳида тоифага ажратилади ва асосий жадвалдан олиб турилади. Лекин ҲЕЧ ҚАЧОН ўчирилмайди — тепадаги «ЖАМИ» ҳар доим тўлиқ сумма бўлиб қолади.")}
          </Faq>
        </div>
      </Card>
      </Reveal>
