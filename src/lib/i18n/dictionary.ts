...
export const DICTIONARY: Record<string, Entry> = {
  ...
  'Шу email билан рўйхатдан ўтганда — иш майдонингизга тушади.': {
    ru: 'Когда он зарегистрируется с этим email — попадёт в ваше рабочее пространство.',
    en: 'When they sign up with this email, they join your workspace.',
  },
  'Парол керак эмас: шу email билан рўйхатдан ўтса — ўзи иш майдонингизга тушади.': {
    ru: 'Пароль не нужен: если зарегистрируется с этим email — сам попадёт в ваше рабочее пространство.',
    en: 'No password needed: signing up with this email joins your workspace automatically.',
  },
